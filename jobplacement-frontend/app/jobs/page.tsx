...
export default function JobListPage() {
  return (
    <div className="min-h-screen bg-white py-10">
      <h1 className="text-3xl font-bold text-black mb-8">Available Jobs</h1>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        <div className="border rounded-xl p-6 shadow-md hover:shadow-lg transition">
          ...
          <p className="text-black font-bold mt-1">Pretoria • Full-time</p>
        ...
        <div className="border rounded-xl p-6 shadow-md hover:shadow-lg transition">
          <Image
            ...
            className="mb-4"
          />
          <h2 className="text-xl font-bold text-black">Backend Developer</h2>
          <p className="text-black font-bold mt-1">Johannesburg • Hybrid</p>
          <div className="flex gap-2 mt-4">
